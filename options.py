...
parser.add_argument("--max_len", default=256, type=int, help="max length of seqeunce")
parser.add_argument("--window", default=64, type=int, help="temporal window size")
...
parser.add_argument(
    "--n_gcn_layers", default=2, type=int, help="the number of gcn layer"
)
parser.add_argument("--gcn_c_in", default=2, type=int, help="the number of gcn layer")
parser.add_argument("--gcn_c_out", default=4, type=int, help="the number of gcn layer")
parser.add_argument("--graph", default="A", type=str, help="ver adj matrix")
parser.add_argument("--hop", default=2, type=int, help="the number hop for adj matrix")
parser.add_argument(
...
parser.add_argument("--flip_x_v2", default=False, type=bool)
parser.add_argument("--rotate", default=False, type=bool)
parser.add_argument("--drop_lm", default=False, type=bool)
...
parser.add_argument("--k", default=3, type=int, help="arcface subclass")
parser.add_argument(
    "--alpha", default=0.1, type=float, help="cross entropy weight when arcface is used"
)
parser.add_argument(
    "--beta", default=1.0, type=float, help="arcface weight when arcface is used"
)
parser.add_argument("--gclip", default=None, type=float)
parser.add_argument("--sd", default=False, type=bool, help="scheduled dropout")
parser.add_argument("--weight", default=False, type=bool, help="class weight")
parser.add_argument("--clean_data", default=False, type=bool, help="clean data")
# ========================= Monitor Configs ==========================
